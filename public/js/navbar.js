...
if (document.title === "Dicas") {
  document.getElementById("navbar-dicas").style.color = "#05AC4B";
  document.getElementById("navbar-dicas").style.textDecoration = "underline";
  document.getElementById("navbar-dicas").style.textDecorationThickness = "2px";
}